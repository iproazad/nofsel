      ...
      if (person.maritalStatus || person.occupation || person.imprisonment || person.idNumber) {
        cardContent += `
          <div class="info-group">
            ...
            <div class="info-value">${person.maritalStatus || '-'}</div>
          </div>
          <div class="info-group">
          ...
          <div class="info-group">
            <div class="info-label">محكوم بالسجن:</div>
            <div class="info-value">${person.imprisonment || '-'}</div>
          </div>
          <div class="info-group">
            <div class="info-label">رقم الهوية:</div>
            <div class="info-value">${person.idNumber || '-'}</div>
          </div>
        `;
      }
    });
